...
export class Default1685407956270 implements MigrationInterface {
    name = 'Default1685407956270'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`employee\` (\`idEmployee\` int NOT NULL AUTO_INCREMENT, \`nameEmployee\` varchar(255) NOT NULL, \`cpfEmployee\` varchar(255) NOT NULL, \`salaryEmployee\` decimal(5,2) NOT NULL, PRIMARY KEY (\`idEmployee\`)) ENGINE=InnoDB`);
